...
import { LIFF_URL, startLineLiffLogin } from "@/lib/liff";
  ...
  return (
    <section className="section">
      <form onSubmit={onSubmit} className="card-soft mx-auto max-w-md space-y-4">
        ...
        <a
          href={LIFF_URL}
          onClick={() => startLineLiffLogin()}
          className="block rounded-xl border border-[#06C755] px-4 py-3 text-center text-sm font-semibold text-[#06C755]"
        >
          {t("line")}
        </a>
